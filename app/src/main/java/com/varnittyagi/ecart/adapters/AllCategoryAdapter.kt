...
import com.varnittyagi.ecart.models.allcategorydetails.Product

class AllCategoryAdapter (private var context:Context, private var listener:OnItemClickListener) : RecyclerView.Adapter<AllCategoryAdapter.mviewHolder>() {
...
val currentitem = items[position]
        ...
        holder.mainitemLL.setOnClickListener {
    ...
    interface OnItemClickListener {
        fun onItemClicks(modelClass:ArrayList<Product>, position: Int)
    }
}
